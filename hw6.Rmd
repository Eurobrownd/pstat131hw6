...
The best performing model was (mtry = 7, trees = 10, and min_n = 4) with a roc_auc score of 0.7218
...
10 trees had the highest roc_auc score while the lowest score is around 231 trees.
...
roc_aucs
```
From the three, it seems that the boosted tree tree model with 10 trees performed best with 0.7349 roc_auc score
...
The model was best at predicting normal types followed by water types. Fire and grass was the worst as it only got 1 correct
on both of them. And the model was okay at predicting bug types as well.